...
for (const theory of ["ieee_float", "set", "bv", "map", "string", "seq", "list", "bag", "fmap", "bintree", "stack", "queue", "pqueue", "relations", "int", "number", "real"]) {
...
console.log("CVC5 " + cvc5.version + ": " + cvc5.command);
